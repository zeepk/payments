...
def send_welcome_email(username, email):
    ...
    user_email = ('Welcome to Bill Me Later!', user_message, 'admin@billmelater.com', [email])
    admin_message = ('A user has signed up for Bill Me Later! Username: ' + username +'; Email: ' + email)
    admin_email= ('User Sign-Up @ Bill Me Later', admin_message, 'admin@billmelater.com', ['mhughes.ipod@gmail.com'])
